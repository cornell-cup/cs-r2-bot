...
void RPLidarController::test() {
	printf("test");
}

void RPLidarController::startLidar(string comport, string baudrate) {
	const char * opt_com_path = NULL;
	_u32         opt_com_baudrate = 115200;
	string		 response;

	opt_com_path = comport.c_str();
	opt_com_baudrate = strtoul(baudrate.c_str(), NULL, 10);
